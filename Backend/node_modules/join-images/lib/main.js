...
function joinImages(images, { direction = 'vertical', color = { alpha: 0.5, b: 0, g: 0, r: 0 }, align = 'start', offset = 0, margin, } = {}) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const processImg = (img) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            let offsetX = 0;
            let offsetY = 0;
            if (is_plain_obj_1.default(img)) {
                const { src, offsetX: x, offsetY: y } = img;
                offsetX = +x;
                offsetY = +y;
                imageSrc = src;
            }
            const meta = yield sharp_1.default(imageSrc).metadata();
        ...
        const { top, right, bottom, left } = calcMargin_1.default(margin);
        ...
        const imageBase = sharp_1.default({
            create: {
                background: color,
                channels: 4,
        ...
        const compositeData = imgData.map((imgData, index) => {
            ...
            const [px, py] = isVertical
                ? [alignImage_1.default(totalWidth, width, align) + offsetX, y + index * offset]
                : [
                    x + index * offset,
                    alignImage_1.default(totalHeight, height, align) + offsetY,
                ];
            return {
                input: buffer,
